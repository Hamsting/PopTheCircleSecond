...
namespace PopTheCircle.Game
{
    ...
    public class DragNoteRenderer : NoteRenderer
    {
        ...
        public override void InitializeNote()
        {
            ...
            Vector3 scale = noteSpriteRenderer.transform.localScale;
            scale.x = ((dragNote.direction == 0) ? 1.0f : -1.0f) * ((dragNote.railNumber == 0) ? -1.0f : 1.0f);
            noteSpriteRenderer.transform.localScale = scale;
        }
